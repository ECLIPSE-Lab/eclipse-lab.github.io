...
- **Large-scale dose-efficient 3D imaging**
  ...
  We are leaders in development of 3D imaging methods based on 4D-STEM measurements. 

    - [first atomic-resolution 3D volume from 4D-STEM tomography](https://www.nature.com/articles/s41467-023-43634-z) 
    - first atomic-resolution phase-contrast volume beyond the depth of focus limit
    - [first end-to-end reconstruction reaching sub-Angstrom resolution](https://doi.org/10.1088/1402-4896/ad9a1a)
