...
**Current status**  
We recently demonstrated gap-free, quantitative 3D structure retrieval at atomic resolution by fusing complementary scattering channels in 4D-STEM (arXiv:2512.19460, You et al., 2025). This approach overcomes the depth-of-focus limitation of conventional ADF tomography by combining differential phase contrast (DPC) and annular dark-field (ADF) signals, enabling truly gap-free information transfer across spatial frequencies. We are now extending this framework to multi-modal fusion of EELS, EDS, and Electron Holography channels.
