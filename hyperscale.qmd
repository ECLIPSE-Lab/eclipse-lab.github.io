...
Within this project, we will turn the tables by utilizing and inverting the scattering physics to image scale-
...
We will use tomographic experiments and computationally invert the multiple scattering from multidimensional
...
computational complexity of the underlying algorithms and a lack of experimental automation, which we plan to
