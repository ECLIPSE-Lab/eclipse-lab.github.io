...
::: {.lead}
  Welcome to the
  <picture>
    <source type="image/avif" srcset="./img/optimized/eclipse_header-540.avif 540w, ./img/optimized/eclipse_header-810.avif 810w, ./img/optimized/eclipse_header-1080.avif 1080w" sizes="65vw">
